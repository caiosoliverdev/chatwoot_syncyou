  ...
  <Story title="Components/Input" :layout="{ type: 'grid', width: '400' }">
    ...
    <Variant title="With Message">
      <div class="flex flex-col gap-4 p-4 bg-white dark:bg-slate-800">
        <Input label="Email" placeholder="Enter your email" message="We'll never share your email." />
        <Input label="Senha" type="password" placeholder="Enter your password" message="Password is incorrect"
          message-type="error" />
        <Input label="Verification Code" placeholder="Enter the code" message="Code verified successfully"
    ...
    <Variant title="Different Types">
      <div class="flex flex-col gap-4 p-4 bg-white dark:bg-slate-800">
        ...
        <Input label="Senha" type="password" placeholder="Password input" />
    ...
    <Variant title="Custom Input Class">
      <div class="p-4 bg-white dark:bg-slate-800">
        <Input label="Custom Style" placeholder="Custom input class"
