...
export const customAttributes = [
  {
    id: 1,
    attribute_display_name: 'Inscrito em',
    attribute_display_type: 'date',
    attribute_description: 'Este é um teste',
  ...
  {
    id: 2,
    attribute_display_name: 'Usuário Prime',
  ...
  {
    id: 5,
    attribute_display_name: 'Minha lista',
    attribute_display_type: 'list',
    attribute_description: 'Esta é uma lista de amostra',
  ...
  {
    id: 6,
    attribute_display_name: 'Meu cheque',
    attribute_display_type: 'checkbox',
    attribute_description: 'Caixa de seleção de teste',
  ...
  {
    id: 7,
    attribute_display_name: 'Lista de Con',
    attribute_display_type: 'list',
    attribute_description: 'Esta é uma lista de teste\n',
  ...
  },
  {
    ...
    attribute_display_type: 'link',
    attribute_description: 'Este é um texto',
    attribute_key: 'asdf',
    attribute_values: [],
    attribute_model: 'contact_attribute',
    default_value: null,
...
export const filterAttributes = [
  ...
  },
  {
    ...
    filterOperators: [
      ...
      { value: 'not_equal_to', label: 'Não é igual a' },
  ...
  },
  {
    ...
    name: 'Atributos personalizados de conversação',
    disabled: true,
  },
  {
    key: 'signed_up_at',
    ...
    filterOperators: [
      { value: 'equal_to', label: 'Igual a' },
      { value: 'not_equal_to', label: 'Não é igual a' },
      { value: 'is_present', label: 'Está presente' },
      { value: 'is_not_present', label: 'Não está presente' },
      { value: 'is_greater_than', label: 'É maior que' },
      { value: 'is_less_than', label: 'É menor que' },
    ],
  },
  {
    key: 'test',
...
export const inboxes = [
  {
    ...
    pre_chat_form_options: {
      ...
      pre_chat_message: 'Compartilhe suas dúvidas ou comentários aqui.',
    },
