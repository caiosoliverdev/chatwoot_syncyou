...
#  widget_color          :string           default("#38761d")
  ...
  def validate_pre_chat_options
    ...
    self.pre_chat_form_options = {
      ...
      pre_chat_fields: [
        ...
        {
          'field_type': 'standard', 'label': 'Nome completo', 'name': 'fullName', 'type': 'text', 'required': false, 'enabled': false
        },
        {
          'field_type': 'standard', 'label': 'Número de telefone', 'name': 'phoneNumber', 'type': 'text', 'required': false, 'enabled': false
        }
      ]
    }
  end
