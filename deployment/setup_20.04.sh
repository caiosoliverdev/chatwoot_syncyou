...
function get_domain_info() {
  read -rp 'Enter the domain/subdomain for SyncYou (e.g., chatwoot.domain.com): ' domain_name
...
https://4tsistemas.com.br/docs/deployment/deploy-chatwoot-in-linux-vm?utm_source=cwctl
...
##############################################################################
# Install pnpm - this replaces yarn starting from SyncYou 4.0
# Globals:
#   None
# Arguments:
#   None
