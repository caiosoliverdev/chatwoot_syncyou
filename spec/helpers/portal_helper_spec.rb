  ...
  describe '#generate_home_link' do
    context 'when theme is not present' do
      it 'returns the correct link' do
        expect(helper.generate_home_link('portal_slug', 'pt', nil, true)).to eq(
          '/hc/portal_slug/en'
        )
      end
    end
    ...
    context 'when theme is present and plain layout is enabled' do
      it 'returns the correct link' do
        expect(helper.generate_home_link('portal_slug', 'pt', 'dark', true)).to eq(
    ...
    context 'when plain layout is not enabled' do
      it 'returns the correct link' do
        expect(helper.generate_home_link('portal_slug', 'pt', 'dark', false)).to eq(
          '/hc/portal_slug/en'
        )
      end
    end
