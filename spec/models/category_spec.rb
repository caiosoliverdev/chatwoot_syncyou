...
RSpec.describe Category do
  ...
  describe 'validations' do
    ...
    let!(:portal) { create(:portal, account_id: account.id, config: { allowed_locales: ['pt'] }) }

    it 'returns erros when locale is not allowed in the portal' do
      category = create(:category, slug: 'category_1', locale: 'pt_BR', portal_id: portal.id)
  ...
  describe 'search' do
    ...
    before do
      create(:category, slug: 'category_1', locale: 'pt_BR', portal_id: portal_1.id)
